...
def choose_safe_room(recent_100, lose_streak=0, last_win_room=None, user_id=None, issue_id=None):
    ...
    if lose_streak >= 2:
        ...
        candidates -= set(full_history[:5])
        hot_rooms = {r for r, c in Counter(full_history[:15]).items() if c >= 2}
...
def main():
    ...
    session_state = { 
        ...
        "rounds_played_this_session": 0, "rounds_to_skip": 0, "last_win_room": None,
